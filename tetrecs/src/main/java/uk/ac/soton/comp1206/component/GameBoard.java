...
public class GameBoard extends GridPane {
    ...
    protected GameBlock createBlock(int x, int y) {
        ...
        //when right mouse is clicked, it should rotate the piece
        //block.setOnMouseClicked((e) -> setOnRightClicked(e, block));
    ...
    /*
    private void setOnRightClicked(MouseEvent event, GameBlock block) {
        logger.info("Method if right mouse button is pressed");

        //if the right click is pressed down then do this
        //if (event.isSecondaryButtonDown()) {
            //rightClickedListener.setOnRightClicked(block);
        ...
        logger.info("Attempted rotating music");
        Multimedia.playAudioFile("sounds/rotate.wav");
    }
    */
